...
router.post ('/upgrade-profile' , requiresAuth , requiresToBeAdmin , async (req: RequestInterface , res: ResponseInterface , next: Next) => {
    try {
        ...
        return warn (res , FORBIDDEN , e || 'You are not authorized as Admin Profile');
    }
    next ();
})
